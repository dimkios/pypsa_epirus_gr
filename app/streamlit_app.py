...
with tab_gen:
    ...
    st.caption(
        ...
        "'γεννήτρια' εισαγωγών (marginal_cost=60, χρησιμοποιείται μόνο αν όλα τα άλλα δεν "
        "επαρκούν) + **7 γεννήτριες 'ΑΠΕ (υπάρχουσα)'** που αναπαριστούν την ήδη εγκατεστημένη, "
